...
Rules:
- For CI, lint, or fix tasks use the workflow_run tool only. Do not run bun run, npm run, or similar in the terminal.
- Call workflow_run with one of: ci, lint:tsc, lint:eslint, lint:prettier, lint:cspell, lint:jscpd, lint:markdown, fix:eslint, fix:prettier.
