...
- Call workflow_run with one of: run, dev, test, ci, lint:tsc, lint:eslint, lint:prettier, lint:stylelint, lint:cspell, lint:jscpd, lint:knip, lint:markdown, fix:eslint, fix:prettier, fix:stylelint.
