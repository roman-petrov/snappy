...
export const FileSelectView = ({ children, disabled, fileName, hint, pick, pickLabel }: FileSelectViewProps) => (
  <div className={styles.root}>
    <div className={styles.picker}>
      ...
      {fileName === undefined || fileName === `` ? undefined : (
        <span className={_.cn(styles.fileName, $.typography(`caption`))}>{fileName}</span>
      )}
    </div>
    {children}
  </div>
