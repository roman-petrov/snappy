...
export type BusyShimmerOptions = { accentColor?: number; speed?: number };

const defaultAccent = 0x00_88_89_b3;

export const BusyShimmer = (element: HTMLElement, options: BusyShimmerOptions, webgl: WebGlInterface): void => {
...
export { default as BusyShimmerShader } from "./BusyShimmer.shader.glsl?raw";
