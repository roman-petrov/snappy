...
export type SnappyBotConfig = { apiKey: string; apiUrl: string; botToken: string; version?: string };

export const SnappyBot = ({ apiKey, apiUrl, botToken, version }: SnappyBotConfig) => {
  ...
  Commands.register(bot, version, api);
