...
const skillProtocol = `Skill protocol:
...
const questionStrategy = `Question strategy:
...
- If user choice is required, stop execution and request that choice through a tool.`,
  ...
  [`analysis_process`, analysisProcess(withSkillCatalog)],
  [
    `chat_style`,
