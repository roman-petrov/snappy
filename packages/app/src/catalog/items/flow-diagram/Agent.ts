// cspell:disable
import { StaticVisualAgent } from "../../../snappy/static-agent";
...
export const Agent = StaticVisualAgent(
  () =>
    ({
      ...
      "ui.field.data.placeholder": [`Values, categories, units — paste here…`, `Числа, категории, единицы — вставьте…`],
      "ui.field.data.prompt": [`Data to visualize (numbers and labels):`, `Данные для визуализации (числа и подписи):`],
      ...
      "ui.field.legend.option.right.prompt": [`Legend to the right of the plot.`, `Легенда справа от области графика.`],
