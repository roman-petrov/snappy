...
const meta = {
  description: [`App icon with style, palette, and 2D or 3D look`, `Иконка приложения — стиль, палитра, 2D или 3D`],
  emoji: `🎯`,
  group: `visual`,
  title: [`Icon`, `Иконка`],
} as const;
...
export const preset: Preset = {
  flows: [
    Flow.snappy(meta, {
      prompt: [`I need an app or product icon.`, `Нужна иконка приложения или продукта.`],
