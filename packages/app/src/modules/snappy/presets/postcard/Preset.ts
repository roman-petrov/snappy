...
const meta = {
  description: [`Greeting card front — rich art options`, `Открытка — много вариантов оформления`],
  emoji: `💌`,
  group: `visual`,
  title: [`Postcard`, `Открытка`],
} as const;

export const preset: Preset = {
  flows: [
    Flow.snappy(meta, {
      prompt: [`I want a greeting card illustration.`, `Хочу иллюстрацию для открытки.`],
