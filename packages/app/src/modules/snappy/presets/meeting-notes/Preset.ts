...
const meta = {
  description: [
    `Meeting recording turned into notes, decisions, and actions`,
    `Запись встречи в протокол с итогами и задачами`,
  ],
  emoji: `📋`,
  group: `audio`,
  title: [`Meeting notes`, `Протокол встречи`],
} as const;
...
export const preset: Preset = {
  flows: [
    Flow.snappy(meta, {
      prompt: [
        `I have a meeting recording — I need notes with action items.`,
        `Есть запись встречи — нужны заметки с задачами.`,
      ],
