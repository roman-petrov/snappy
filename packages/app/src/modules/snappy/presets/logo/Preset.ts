...
const meta = {
  description: [`Logo concepts with style and color options`, `Концепции логотипа — стиль и палитра`],
  emoji: `🏷️`,
  group: `visual`,
  title: [`Logo`, `Логотип`],
} as const;
...
export const preset: Preset = {
  flows: [
    Flow.snappy(meta, {
      prompt: [
        `I need a logo or brand mark concept — I'll describe the business.`,
        `Нужен концепт логотипа или знака — опишу бизнес.`,
      ],
