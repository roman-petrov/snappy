  ...
  flows: [
    ...
    Flow.staticVisual(meta, {
      ...
      localization: () => ({
        ...
        "ui.field.colorScheme.option.colorful.prompt": [
          `Distinct colors per department/level.`,
          `Разные цвета по отделам/уровням.`,
        ],
        "ui.field.colorScheme.option.corporate.label": [`Corporate`, `Корпоративные`],
        "ui.field.colorScheme.option.corporate.prompt": [
          `Navy, gray, white corporate palette.`,
          `Navy, серый, белый — корпоративная палитра.`,
        ],
        ...
        "ui.field.visualStyle.option.modern.prompt": [
          ...
          `Скруглённые карточки, лёгкие тени.`,
        ],
      }),
    }),
  ],
