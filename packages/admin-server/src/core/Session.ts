...
const isPayload = (value: unknown): value is SessionPayload =>
...
const parseToken = (token: string): SessionPayload | undefined => {
...
export const Session = { apply, clear, credentialsMatch, issue, verify };
