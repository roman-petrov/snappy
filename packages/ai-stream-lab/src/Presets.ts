...
export const Presets = {
  "flicker-code": { fixture: `code`, profile: `cut-code`, speed: `fast`, theme: `chat` },
  "flicker-emphasis": { fixture: `emphasis`, profile: `cut-emphasis`, speed: `fast`, theme: `chat` },
  "flicker-list": { fixture: `lists`, profile: `cut-list`, speed: `fast`, theme: `chat` },
  "flicker-table": { fixture: `table`, profile: `cut-table`, speed: `fast`, theme: `chat` },
  "modes": { fixture: `showcase`, profile: `token`, speed: `stream`, theme: `chat` },
  "perf": { fixture: `lists`, profile: `burst`, speed: `stream`, theme: `chat` },
  "table-hang": { fixture: `table`, profile: `hang-mid`, speed: `slow`, theme: `chat` },
